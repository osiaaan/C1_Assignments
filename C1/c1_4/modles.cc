...
//t does not represent the timestep necessarily, it's just a constant which
//I multiply the matrix (Usually set to 1)
//This will be used in Newto-Raphson during the evolve function
const SparseMatrix HeatEquation::df(double t) const
{
  ...
  double diag = -3*t/(h*h);//The minus is to account for the identity matrix being negated
